...
* *LENS<sub>PEMS</sub>*, a customization for Programmable Electronic Medical Systems ([source](https://github.com/foselab/LENS4PEMS/raw/main/docs/abilities.json))
